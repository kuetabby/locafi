  ...
  return (
    <div className="stakepage-container">
      ...
      <div className="w-full md:w-11/12 lg:w-4/5 h-full flex flex-wrap justify-between mx-auto relative">
        <Card className="w-full md:w-3/5 bg-dark-secondary text-white rounded-2xl">
        ...
        <div className="w-full md:w-[35%] mt-4 md:mt-0">
          <Card className="bg-dark-secondary text-white font-semibold rounded-2xl">
            <CardHeader className="pb-0 text-pink">Total Staked</CardHeader>
            <CardBody>{displayTotalStaked}</CardBody>
          </Card>
          <Card className="bg-dark-secondary my-3 text-white font-semibold rounded-2xl">
