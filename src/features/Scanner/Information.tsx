            ...
            <Card className="w-full h-full bg-dark-secondary rounded-lg text-white">
              ...
              <CardBody>
                ...
                <div className="w-full">
                  <div>Tax Rate</div>
                  <div className="w-[11em] flex justify-between mt-3 font-semibold">
              ...
              <CardFooter className="w-full pt-0">
                <div className="w-full xs:w-3/4 sm:w-full flex flex-wrap justify-center mx-auto">
